...
class TestShouldOfferCudaPrompt:
    ...
    def test_returns_true_on_linux_regardless_of_packaging(self, monkeypatch):
        # The installer works from a private venv, so a bare pip or source
        # install is offered the same as a snap, Flatpak or AppImage.
