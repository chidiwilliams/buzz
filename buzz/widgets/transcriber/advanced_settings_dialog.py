...
class AdvancedSettingsDialog(QDialog):
    ...
    def __init__(
        ...
        self._setup_transcription_section(layout)
        self._setup_translation_section(layout)
    ...
    def _setup_translation_section(self, layout: QFormLayout):
        ...
        self.llm_model_line_edit.setPlaceholderText("add-model-id-here")
        ...
        if not self.transcription_options.llm_prompt:
            # The default prompt is shown pre-filled, so make it the actual value too.
            # Otherwise it is never applied unless the user edits the field.
            self.transcription_options.llm_prompt = _(
    ...
    def _setup_recording_section(self, layout: QFormLayout):
        ...
        self.silence_threshold_spin_box.setValue(self.transcription_options.silence_threshold)
        ...
        line_sep_display = repr(self.transcription_options.line_separator)[1:-1] or r"\n\n"
        ...
        self.transcription_step_spin_box.setValue(self.transcription_options.transcription_step)
